...
Bridget's camera, which\n\
is directly behind him.\n\
Press [R] again to return\n\
to Lakitu's camera. Press\n\
[C]| to see Bridget from\n\
afar, using either\n\
Lakitu's or Bridget's view."))
...
Bridget 64! This is the\n\
end of the game, but not\n\
the end of the fun." \
KEEP_ON_PLAYING "』\n\
\n\
The Super Bridget 64 Team"))
